...
class ScenarioCompletionHandler:
    ...
    def __init__(self, game):
        ...
        # Effect parameters
        self.vertical_height = SCREEN_HEIGHT
        self.horizontal_width = SCREEN_WIDTH
    ...
    def update(self, dt: float):
        ...
        if self.stage == 0:
            ...
            self.vertical_height = SCREEN_HEIGHT * (1.0 - self._ease_in_expo(progress))
            ...
            self.horizontal_width = SCREEN_WIDTH * (1.0 - self._ease_in_expo(progress))
    ...
    def draw(self, screen: pygame.Surface):
        ...
        if self.stage == 0:
            ...
            if self.horizontal_width > 0:
                ...
                rect = pygame.Rect(int(left), self.center_y - 1, max(1, int(self.horizontal_width)), 3)
                pygame.draw.rect(screen, (brightness, brightness, brightness), rect)
            ...
            if alpha > 0:
                ...
                screen.blit(glow, (self.center_x - size, self.center_y - size))
